...
<!--==============================Content=================================-->
		<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - February 10, 2014!</div>
			<div class="container_12">
				<div class="grid_7">
					<h4>Transport Details: ${transport.getName()}</h4>
				<form:form class="form-horizontal" role="form" commandName="pack"
					action="./update/" method="post">

					<div class="form-group">
						<label class="col-sm-2 control-label">Transport Name: ${transport.getName()} </label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Seats: ${transport.getSeats()}</label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Maximum Bags: ${transport.getMaxBag()}</label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Price: ${transport.getPrice()}$</label>
					</div>
