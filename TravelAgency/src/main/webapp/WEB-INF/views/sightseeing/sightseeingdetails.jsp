...
<!--==============================Content=================================-->
		<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - February 10, 2014!</div>
			<div class="container_12">
				<div class="grid_7">
					<h4>Sightseeing Details: ${sightseeing.getName()}</h4>
				<form:form class="form-horizontal" role="form" commandName="pack"
					action="./update/" method="post">

					<div class="form-group">
						<label class="col-sm-2 control-label">Sightseeing Name: ${sightseeing.getName()} </label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Description: ${sightseeing.getDescription()}</label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Durations: ${sightseeing.getDurations()} Hrs</label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Adult Price: ${sightseeing.getAdultPrice()}</label>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">Child Price: ${sightseeing.getChildPrice()}</label>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label">Place: ${sightseeing.place}</label>
					</div>
