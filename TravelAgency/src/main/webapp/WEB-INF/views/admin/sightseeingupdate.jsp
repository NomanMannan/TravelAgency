...
<title>Discover Thailand: Update Sightseeing</title>
...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-primary margin_top_20">
			<div class="panel-heading">Update Sightseeing: ${sightseeing.name}</div>
			<div class="panel-body">
				<form:form class="form-horizontal" role="form" commandName="sightseeing"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="id"
								autocomplete="on" value="${sightseeing.getId()}" readonly="true" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="name"
								placeholder="name" value="${sightseeing.getName()}"
								autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:textarea type="text" cssClass="form-control"
								...
								value="${sightseeing.getDescription()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="durations"
								placeholder="durations" value="${sightseeing.getDurations()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="price" cssClass="form-control" path="adultPrice"
								placeholder="adult price" value="${sightseeing.getAdultPrice()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="price" cssClass="form-control" path="childPrice"
								placeholder="child price" value="${sightseeing.getChildPrice()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
