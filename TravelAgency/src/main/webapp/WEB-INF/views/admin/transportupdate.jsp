...
<title>Discover Thailand: Update Transport</title>
...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-primary margin_top_20">
			<div class="panel-heading">Update Transport: ${transport.name}</div>
			<div class="panel-body">
				<form:form class="form-horizontal" role="form" commandName="transport"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="id"
								autocomplete="on" value="${transport.getId()}" readonly="true" />
						</div>
					</div>
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="name"
								placeholder="name" value="${transport.getName()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="seats"
								placeholder="seats" value="${transport.getSeats()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="maxBag"
								placeholder="max bags" value="${transport.getMaxBag()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="price"
								placeholder="price" value="${transport.getPrice()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
