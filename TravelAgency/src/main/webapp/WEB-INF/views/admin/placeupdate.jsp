...
<title>Discover Thailand: Update Place</title>
...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-primary margin_top_20">
			<div class="panel-heading">Update Place: ${place.name}</div>
			<div class="panel-body">
				<form:form class="form-horizontal" role="form" commandName="place"
					action="./update/" method="post">

					<div class="form-group">
						<label class="col-sm-2 control-label">Place ID: </label>
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="id"
								autocomplete="on" value="${place.getId()}" readonly="true" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:input type="text" cssClass="form-control" path="name"
								placeholder="name" value="${place.getName()}"
								autocomplete="off" />
						</div>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<form:textarea type="text" cssClass="form-control"
								...
								value="${place.getDescription()}" autocomplete="off" />
						</div>
						<div class="col-sm-3">
